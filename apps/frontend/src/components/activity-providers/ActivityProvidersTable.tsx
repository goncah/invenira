...
export default function ActivityProvidersTable() {
    ...
    const handleDelete = () => {
        ...
        apService.delete(deleteTarget.id, token())
            .then(() => apService.getAll(token()).then(data => setAplist(data)))
    ...
    const handleAdd = () => {
        ...
        apService.create(newEntry, token())
            .then(() => apService.getAll(token()).then(data => setAplist(data)))
    ...
    return (
        <>
            ...
            >
                ...
                <DialogContent>
                    <DialogContentText>
                        Are you sure you want to delete the activity provider {deleteTarget?.name}?
                    </DialogContentText>
                </DialogContent>
                <DialogActions>
